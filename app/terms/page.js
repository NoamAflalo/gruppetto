  ...
  return (
    <div className="min-h-screen bg-ground">
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-6 py-8 md:py-12">
        <h1 className="text-3xl md:text-4xl font-black text-ink mb-8">Terms & Conditions</h1>
        ...
        <div className="bg-card rounded-2xl border border-line p-6 md:p-8 space-y-6 text-soft">
          ...
          <section>
            <h2 className="text-xl font-bold text-ink mb-3">2. Use of Service</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-ink mb-3">4. Liability Disclaimer</h2>
            <p className="font-semibold text-brand-soft mb-2">IMPORTANT: Please read carefully</p>
          ...
          <section>
            <h2 className="text-xl font-bold text-ink mb-3">5. Content Guidelines</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-ink mb-3">6. Account Termination</h2>
            <p>We reserve the right to suspend or terminate accounts that violate these terms or engage in harmful behavior.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-ink mb-3">7. Changes to Terms</h2>
